...
public class StringManager {
    ...
    static {
        ...
        add(Message.ADDED, "Dodano figurę: ", "shapes.Shape added: ");
        add(Message.DELETED, "Usunięto figurę", "shapes.Shape deleted");
        ...
        add(Message.NOT_ADDED_ALREADY_EXISTS,
                ...
                "shapes.Shape was not added - that shape already exists."
        );
